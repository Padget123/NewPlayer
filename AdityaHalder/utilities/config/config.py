...
OWNER_ID = list(map(int, getenv("OWNER_ID", "5745099463").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Padget123/NewPlayer")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "aditya")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Sad_shayari_lovers")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/FriendshipWorldGroup")
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/Team-Alisha/AlishaMusic")
...
START_IMG_URL = getenv("START_IMG_URL", f"https://telegra.ph//file/59f6eee7bcc5f34b4102b.jpg")
